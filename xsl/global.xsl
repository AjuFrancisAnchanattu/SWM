...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:include href="../snapins/bbcNews/bbcNews.xsl" />
	<xsl:include href="../snapins/traffic/traffic.xsl" />
	...
	<xsl:include href="../apps/complaints/snapins/complaintsHomepage/complaintsHomepage.xsl" />
	...
	<xsl:include href="../snapins/myPerformance/myPerformance.xsl" />
	<xsl:include href="../snapins/weather/weather.xsl" />
	<xsl:include href="../snapins/video/video.xsl" />
	<xsl:include href="../snapins/gallery/gallery.xsl" />
	<xsl:include href="../snapins/usefulLinks/usefulLinks.xsl" />
	<xsl:include href="../snapins/myPerformance/myPerformance.xsl" />
	<xsl:include href="../snapins/supportTickets/supportTickets.xsl" />
	<xsl:include href="../snapins/scapavision/scapavision.xsl" />
	<xsl:include href="../snapins/employeeSurvey/employeeSurvey.xsl" />
	...
	<xsl:include href="../snapins/scapaInstantMessaging/scapaInstantMessaging.xsl" />
	<xsl:include href="../snapins/stockMarket/stockMarket.xsl" />
	<xsl:include href="../snapins/poll/poll.xsl" />
	<xsl:include href="../snapins/vacancies/vacancies.xsl" />
	
	<xsl:include href="../controls/textbox/textbox.xsl" />
	<xsl:include href="../controls/dropdown/dropdown.xsl"/>
	<xsl:include href="../controls/checkbox/checkbox.xsl"/>
	...
	<xsl:include href="../controls/combo/combo.xsl"/>
	<xsl:include href="../controls/combo/comboCustomColumns.xsl"/>
	...
	<xsl:include href="../controls/calendar/calendar.xsl" />
	<xsl:include href="../controls/multipleCC/multipleCC.xsl" />
	<xsl:include href="../controls/multiNTLogon/multiNTLogon.xsl" />
	
	<xsl:include href="../controls/htmlEditor/htmlEditor.xsl" />
	
	<xsl:include href="../controls/itemPopUp/itemPopUp.xsl" />
	...
	<xsl:include href="../apps/documentLinks/snapins/sections/sections.xsl" />
	...
	<xsl:include href="../apps/ijf/snapins/additionalLinks/additionalLinks.xsl" />
	
	<xsl:include href="../apps/help/snapins/appsSnapin/appsSnapin.xsl" />
	...
	<xsl:include href="../apps/technical/snapins/techEnqHomepage/techEnqHomepage.xsl" />
	...
	<xsl:include href="../apps/npi/snapins/npiDocuments/npiDocuments.xsl" />
	<xsl:include href="../apps/npi/snapins/bookmarkedNPI/bookmarkedNPI.xsl" />
	
	<xsl:include href="../apps/gallery/snapins/uploadpictures/uploadpictures.xsl" />
	<xsl:include href="../apps/gallery/snapins/latestpictures/latestpictures.xsl" />
	<xsl:include href="../apps/gallery/snapins/icons/icons.xsl" />
	<xsl:include href="../apps/gallery/snapins/latestgalleries/latestgalleries.xsl" />
	<xsl:include href="../apps/gallery/snapins/gallerylist/gallerylist.xsl" />
	...
	<xsl:include href="../apps/pricing/snapins/actionPricing/actionPricing.xsl" />
	...
	<xsl:include href="../apps/pricing/snapins/adminTools/adminTools.xsl" />
	<xsl:include href="../apps/pricing/snapins/yourRequests/yourRequests.xsl" />
	<xsl:include href="../apps/pricing/snapins/yourRequestsHistory/yourRequestsHistory.xsl" />
	
	<xsl:include href="../apps/gis/snapins/loadgis/loadgis.xsl" />
	<xsl:include href="../apps/gis/snapins/warning/warning.xsl" />
	<xsl:include href="../apps/gis/snapins/profileTypes/profileTypes.xsl" />
	<xsl:include href="../apps/gis/snapins/newInformation/newInformation.xsl" />
	<xsl:include href="../apps/gis/snapins/archive/archive.xsl" />
	
	<xsl:include href="../apps/productdb/snapins/loadproductdb/loadproductdb.xsl" />
	
	<xsl:include href="../apps/appraisal/snapins/loadappraisal/loadappraisal.xsl" />
	<xsl:include href="../apps/appraisal/snapins/yourappraisal/yourappraisal.xsl" />
	
	<xsl:include href="../apps/video/snapins/videoControl/videoControl.xsl" />
	<xsl:include href="../apps/video/snapins/videoList/videoList.xsl" />
	
	<xsl:include href="../apps/support/snapins/load/load.xsl" />
	<xsl:include href="../apps/support/snapins/yourtickets/yourtickets.xsl" />
	<xsl:include href="../apps/support/snapins/adminTickets/adminTickets.xsl" />
	<xsl:include href="../apps/support/snapins/superAdminTickets/superAdminTickets.xsl" />
	<xsl:include href="../apps/support/snapins/bookmarkedSupport/bookmarkedSupport.xsl" />
	<xsl:include href="../apps/support/snapins/onlineOffline/onlineOffline.xsl" />
	
	<xsl:include href="../apps/serviceDesk/snapins/serviceDeskControl/serviceDeskControl.xsl" />
	<xsl:include href="../apps/serviceDesk/snapins/serviceDeskUsersOnline/serviceDeskUsersOnline.xsl" />
	<xsl:include href="../apps/serviceDesk/snapins/serviceDeskInitiatedTickets/serviceDeskInitiatedTickets.xsl" />
	<xsl:include href="../apps/serviceDesk/snapins/serviceDeskLoad/serviceDeskLoad.xsl" />
	<xsl:include href="../apps/serviceDesk/snapins/serviceDeskBookmarks/serviceDeskBookmarks.xsl" />
	<xsl:include href="../apps/serviceDesk/snapins/serviceDeskProjects/serviceDeskProjects.xsl" />
	<xsl:include href="../apps/serviceDesk/snapins/serviceDeskSapDocs/serviceDeskSapDocs.xsl" />
	<xsl:include href="../apps/serviceDesk/snapins/serviceDeskKey/serviceDeskKey.xsl" />
	<xsl:include href="../apps/serviceDesk/snapins/serviceDeskMain/serviceDeskMain.xsl" />
	<xsl:include href="../apps/serviceDesk/snapins/serviceDeskFaqSearch/serviceDeskFaqSearch.xsl" />
	
	<xsl:include href="../apps/rebates/snapins/loadrebate/loadrebate.xsl" />
	<xsl:include href="../apps/rebates/snapins/yourrebate/yourrebate.xsl" />
	<xsl:include href="../apps/rebates/snapins/detailrebate/detailrebate.xsl" />
	<xsl:include href="../apps/rebates/snapins/bookmarkedRebates/bookmarkedRebates.xsl" />
	<xsl:include href="../apps/rebates/snapins/rebateReferenceDocs/rebateReferenceDocs.xsl" />
	
	<xsl:include href="../apps/comms/snapins/generalComms/generalComms.xsl" />
	<xsl:include href="../apps/comms/snapins/loadComms/loadComms.xsl" />
	<xsl:include href="../apps/comms/snapins/loadAskAQuestion/loadAskAQuestion.xsl" />
	
	<xsl:include href="../apps/dashboard/snapins/dashboardMain/dashboardMain.xsl" />
	<xsl:include href="../apps/dashboard/snapins/dashboardControl/dashboardControl.xsl" />
	<xsl:include href="../apps/dashboard/snapins/zOverdueN/zOverdueN.xsl" />
	<xsl:include href="../apps/dashboard/snapins/cashPositionDB/cashPositionDB.xsl" />
	<xsl:include href="../apps/dashboard/snapins/hitCounter/hitCounter.xsl" />
	<xsl:include href="../apps/dashboard/snapins/dddp/dddp.xsl" />
	
	<xsl:include href="../apps/dashboard/lib/serviceDesk/serviceDeskChart.xsl"/>
	
	<xsl:include href="../apps/dashboard/snapins/salesTracker/salesTracker.xsl" />
	<xsl:include href="../apps/dashboard/snapins/healthAndSafety/healthAndSafety.xsl" />
	<xsl:include href="../apps/dashboard/snapins/dashboardMainHAS/dashboardMainHAS.xsl" />
	<xsl:include href="../apps/dashboard/snapins/dashboardMainHASGroup/dashboardMainHASGroup.xsl" />
	<xsl:include href="../apps/dashboard/snapins/dashboardMainDDDPGroup/dashboardMainDDDPGroup.xsl" />
	<xsl:include href="../apps/dashboard/snapins/dashboardMainCashPosition/dashboardMainCashPosition.xsl" />
	<xsl:include href="../apps/dashboard/snapins/dashboardMainCashPositionEdit/dashboardMainCashPositionEdit.xsl" />
	<xsl:include href="../apps/dashboard/snapins/dunstableActionPlan/dunstableActionPlan.xsl" />
	
	<xsl:include href="../apps/dashboard/snapins/sao/sao.xsl" />
	<xsl:include href="../apps/dashboard/snapins/saoFunnel/saoFunnel.xsl" />
	<xsl:include href="../apps/dashboard/snapins/saoFunnelSalesPeople/saoFunnelSalesPeople.xsl" />
	<xsl:include href="../apps/dashboard/snapins/saoYear/saoYear.xsl" />
	<xsl:include href="../apps/dashboard/snapins/saoYearDifference/saoYearDifference.xsl" />
	<xsl:include href="../apps/dashboard/snapins/saoYearAvg/saoYearAvg.xsl" />
	<xsl:include href="../apps/dashboard/snapins/inventory/inventory.xsl" />
	
	<xsl:include href="../apps/customerComplaints/snapins/ccLoad/ccLoad.xsl" />
	<xsl:include href="../apps/customerComplaints/snapins/ccOwned/ccOwned.xsl" />
	<xsl:include href="../apps/customerComplaints/snapins/ccBookmarks/ccBookmarks.xsl" />
	<xsl:include href="../apps/customerComplaints/snapins/ccDocumentation/ccDocumentation.xsl" />
	<xsl:include href="../apps/customerComplaints/snapins/ccSummary/ccSummary.xsl" />
	
	<xsl:include href="../apps/ceoAwards/snapins/ceoCountdown/ceoCountdown.xsl" />
	<xsl:include href="../apps/ceoAwards/snapins/ceoInfo/ceoInfo.xsl" />
	
	<xsl:include href="../apps/policys/snapins/generalPolicy/generalPolicy.xsl" />
	...
	<xsl:template match="page">
		<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
			...
			<script language="Javascript" src="/lib/charts/FusionCharts/FusionCharts.js" type="text/javascript">-</script>
			<script language="Javascript" src="/lib/charts/FusionCharts/FusionChartsExportComponent.js" type="text/javascript">-</script>
			<script language="Javascript" src="/javascript/popupbox.js" type="text/javascript">-</script>
			<script language="Javascript" src="/javascript/dTree.js" type="text/javascript">-</script>
			...
			<script src="/javascript/noReturnKey/noReturnKey.js" type="text/javascript">-</script>
			
			<!-- jQuery for Date/Time Picker -->
			<link type="text/css" href="/javascript/jQuery/css/smoothness/jquery-ui-1.8.6.custom.css" rel="stylesheet" />
			<script type="text/javascript" src="/javascript/jQuery/js/jquery-1.4.2.min.js">-</script>
			<script type="text/javascript" src="/javascript/jQuery/js/jquery-ui-1.8.6.custom.min.js">-</script>

			<script type="text/javascript">
				jQuery.noConflict();			
			</script>
			<!-- jQuery for Date/Time Picker END -->
	...
	<xsl:template match="home">
		...
		<div class="auto_complete" id="searchTerm_auto_complete" style="z-index: 1000000;">-</div>
	...
	<xsl:template match="dashboard">
		...
		<table width="100%">
			<tr>
				<td valign="top" style="width: 33%; background: url(/images/dotted_background.gif) repeat-y top right;">
				...
				<td valign="top" style="width: 33%; background: url(/images/dotted_background.gif) repeat-y top right;">
					...
					<div id="snapin_middle_container">

						<xsl:apply-templates select="snapin_middle" />
		...
		<![CDATA[
			...
			Sortable.create('snapin_middle_container',
			{
				tag:'div',
				handle:'snapin_top',
				onUpdate:function(element)
				{
					new Ajax.Request('/home/moveDashboardSnapin',
					{
						parameters:Sortable.serialize('snapin_middle_container',
						{
							tag:'div',
							name:'snapins'
						}),
			 ...
			 <div class="left-bot-corner">
			    <div class="inner">
			       ...
			       <xsl:if test="@canClose = 'true'">
									<a class="fright" href="/home/snapinManage?delete={@class}&amp;area={@area}&amp;dashboardLocation={@dashboardLocation}"><img src="/images/snapins/close.gif" height="15" width="15" alt="" /></a>
								</xsl:if>

								<p style="margin: 0; font-weight: bold; color: #FFFFFF;"><xsl:value-of select="@name" /></p></div>
			    </div>
			 </div>
		      </div>
		   </div>
	...
	<xsl:template match="paralink">
		<a href="{link}"><p style="margin: 0; line-height: 15px;"><xsl:value-of select="text()" /><br /></p></a>
	</xsl:template>
