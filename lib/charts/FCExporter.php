 ...
 */			  
//define ( "SAVE_PATH",  "./apps/dashboard/attachments/healthandsafety/" );
define ( "SAVE_PATH",  "./apps/dashboard/attachments/" . $_REQUEST['dashboardAppName'] . "/" );
 ...
 */
//define ( "HTTP_URI", "http://scapanetdev/apps/dashboard/attachments/healthandsafety/" );
define ( "HTTP_URI", "http://scapanetdev/apps/dashboard/attachments/" . $_REQUEST['dashboardAppName'] . "/" );
...
define ( "RESOURCEPATH","./lib/charts/Resources/" );
