...
class item extends control 
{
	...
	{
		return translate::getInstance()->translate($this->label);
	}
	...
	public function setLargeTextarea($largetextarea)
	{
		$this->largetextarea = $largetextarea;
	}
	
	public function getLargeTextarea()
	{
		return $this->largetextarea;
	}
	...
	public function setExtTable($tableExt)
	{
	...
	public function validate()
	{
		...
		// In here is where conditions for save can go ...			
		...
		if ($this->getVisible())
		{
			...
			switch ($this->getDataType())
			{
				...
				// Added by JM, sure not the best way but to check it anyway ...
				case 'textMinLength':
	...
	public function generateInsertQuery()
	{
		...
		switch ($this->getDataType())
		{
			case 'string':
			case 'text':
			case 'textMinLength': // Added by JM
			case 'decimal':
