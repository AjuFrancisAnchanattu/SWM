...
class snapinDashboardManage extends page
{
	function __construct()
	{
		...
		if (isset($_REQUEST['restoreDefault']))
		{
			...
			$dataset = mysql::getInstance()->selectDatabase("membership")->Execute("DELETE FROM dashboardSnapins WHERE NTLogon='" . currentuser::getInstance()->getNTLogon() . "' AND area IN ('" . implode("','", $areas) . "')");
		}
