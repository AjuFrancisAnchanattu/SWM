		...
		<table width="100%" cellpadding="0">
			<tr>
				...
				<td valign="top" style="padding: 10px;">	
					...
					<h1>Download the offline Customer Contact Report tool</h1>
					
					<div style="background: #ffffe1; border: 1px solid #000000; padding: 5px;">
	                   <p style="margin: 0; line-height: 15px;"><strong>Version 3</strong>. This is the most recent version of the offline tool, make sure that you are up to date.</p>
	                </div>
					...
					<ul>
						<li><a href="ccr_offline.html">Download</a> (All languages)</li>
					</ul>
