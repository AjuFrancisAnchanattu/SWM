 ...
 * @version 15/04/2010
 */
class saoFunnel extends snapin
{
	public $saoDateCalcs;
	...
	public $graphXML = "";
	public $bulbXML = "";
	private $chartName = "sao_chart_funnelCustomer";
	private $snappinName = "sao_summary_funnelCustomer";
	...
	{
		$this->setName(translate::getInstance()->translate($this->snappinName));
	...
	public function output()
	{
		$this->xml .= "<saoFunnel>";
			...
			$this->xml .= "<chartName>" . $this->snappinName . "</chartName>";
	...
	{		
		...
		$this->graphXML = "&#60;chart caption='Top 10 Key Customers' useSameSlantAngle='1' subcaption='" . $subCaption . "' showPercentValues='0' isSliced='1' streamlinedData='0' isHollow='0' decimals='1' baseFontSize='11' &#62;";
		   
		$sql = "SELECT kcg, SUM(salesValue" . $this->saoLib->currency . ") as totalSales, newMrkt 
			FROM sisData			
			WHERE versionNo = '000' 
		...
		if ($buTitle == "BU: All")
		{
			...
			{
				$this->graphXML .= "&#60;set label='" . page::xmlentities($fields['kcg']) . " (" . $fields['newMrkt'] . ")" . "' value='" . $fields['totalSales'] . "' /&#62;";
			}
		}
		else 
		{
			while ($fields = mysql_fetch_array($dataset))
			{
				$this->graphXML .= "&#60;set label='" . page::xmlentities($fields['kcg']) . "' value='" . $fields['totalSales'] . "' /&#62;";
			}
		}
