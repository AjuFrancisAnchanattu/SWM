			...
			<tr>
				...
				<xsl:choose>
					<xsl:when test="allowed='1'">
						...
						<!--<div id="chartdiv{chartName}Pie" align="center"><xsl:value-of select="chartName" />Pie</div>-->
						<!--<div id="chartdiv{chartName}Bar" align="center"><xsl:value-of select="chartName" />Bar</div>-->
						...
						<script type="text/javascript">
					        ...
					        var <xsl:value-of select="chartName" /> = new FusionCharts("<xsl:value-of select="graphChartLocation" />Column2D.swf", "<xsl:value-of select="chartName" />", screenW, "<xsl:value-of select="chartHeight" />");
