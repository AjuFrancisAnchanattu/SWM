...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="dunstableActionPlan">
				...
				<xsl:choose>
					<xsl:when test="allowed='1'">
						...
						<script type="text/javascript">
					        ...
					        var <xsl:value-of select="chartName" /> = new FusionCharts("../../lib/charts/FusionCharts/MSLine.swf", "<xsl:value-of select="chartName" />", screenW, "<xsl:value-of select="chartHeight" />");
