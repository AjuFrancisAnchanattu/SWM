 ...
 * @version 19/08/2009
 */
class dashboardMainHAS extends snapin 
{	
	
	function __construct()
	{
		$this->setName(translate::getInstance()->translate("healthAndSafety_dashboard"));
	...
	{				
		$this->xml .= "<dashboardMainHAS>";
		
		// Permissions at all
		if(currentuser::getInstance()->hasPermission("dashboard_healthAndSafety") && currentuser::getInstance()->hasPermission("dashboard_healthAndSafetyAdd"))
		{
