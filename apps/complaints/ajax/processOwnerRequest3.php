...
class processOwnerRequest3 extends page 
{
	function __construct()
	{
		parent::__construct();
		
		if (!isset($_REQUEST['processOwnerRequest3']))
		{
			die();
		}
		
		$dataset = mysql::getInstance()->selectDatabase("MEMBERSHIP")->Execute("SELECT * FROM employee WHERE (`firstName` LIKE '" . $_REQUEST['processOwnerRequest3'] . "%') ORDER BY `firstname` LIMIT 20");
