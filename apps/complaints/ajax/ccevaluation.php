...
class ccevaluation extends page 
{
	function __construct()
	{
		...
		$dataset = mysql::getInstance()->selectDatabase("MEMBERSHIP")->Execute("SELECT * FROM employee WHERE (`firstName` LIKE '" . $_REQUEST['copyTo'] . "%') ORDER BY `firstname` LIMIT 20");
