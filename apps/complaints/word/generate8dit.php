...
class generate8dit extends page
{	
...
{\*\formfield{\fftype1\ffres25\fftypetxt0\ffhps20{\*\ffname Check1}\ffdefres1}}}}{\fldrslt }}{\fs18\lang2057\langfe1033\langnp2057\insrsid7735582 {\*\bkmkend Check1}";
		...
		$file = './apps/complaints/word/8d-itTemplate.rtf';
		...
		$data = str_replace('[[CU]]',$complaintUndecided,$data);
		...
		$data = str_replace('[[MSDATE]]',$msDate,$data);
		$data = str_replace('[[MSREF]]',$msRef,$data);
		$data = str_replace('[[FCDATE]]',$fcDate,$data);
		$data = str_replace('[[FCREF]]',$fcRef,$data);
		$data = str_replace('[[FMDATE]]',$fmDate,$data);
		$data = str_replace('[[FMREF]]',$fmRef,$data);
		$data = str_replace('[[SCDATE]]',$scDate,$data);
		$data = str_replace('[[SCREF]]',$scRef,$data);
		*/
		...
		// Save the file here
		$fpSaveFile = './apps/complaints/word/files/8d-it' . $fields['id'] .  '.rtf';
		...
		chmod("./apps/complaints/word/files/8d-it" . $fields['id'] .  ".rtf", 0777);
		...
		mysql::getInstance()->selectDatabase("complaints")->Execute("INSERT INTO `documents` (complaintId, type, date, language) VALUES(" . $fields['id'] . ", '8d', '" . common::nowDateForMysql() . "', 'it')");
