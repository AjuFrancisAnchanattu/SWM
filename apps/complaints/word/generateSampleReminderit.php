...
class generateSampleReminderit extends page
{	
	...
	public function generateWordDocument()
	{
		...
		$file = './apps/complaints/word/sampleReminderit.rtf';
		...
		$dateDiff = $this->datediff($fields['openDate'], date("Y-m-d")) . " giorni";
		...
		// Save the file here
		$fpSaveFile = './apps/complaints/word/files/sampleRem-it' . $fields['id'] .  '.rtf';
		...
		chmod("./apps/complaints/word/files/sampleRem-it" . $fields['id'] .  ".rtf", 0777);
		...
		mysql::getInstance()->selectDatabase("complaints")->Execute("INSERT INTO `documents` (complaintId, type, date, language) VALUES(" . $fields['id'] . ", 'sampleRem', '" . common::nowDateForMysql() . "', 'it')");
