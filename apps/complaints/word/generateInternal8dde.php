...
class generateInternal8dde extends page
{	
...
{\*\formfield{\fftype1\ffres25\fftypetxt0\ffhps20{\*\ffname Check1}\ffdefres1}}}}{\fldrslt }}{\fs18\lang2057\langfe1033\langnp2057\insrsid7735582 {\*\bkmkend Check1}";
		...
		$file = './apps/complaints/word/internal8d-deTemplate.rtf';
		...
		// Save the file here
		$fpSaveFile = './apps/complaints/word/files/internal8d-de' . $fields['id'] .  '.rtf';
		...
		chmod("./apps/complaints/word/files/internal8d-de" . $fields['id'] .  ".rtf", 0777);
		...
		mysql::getInstance()->selectDatabase("complaints")->Execute("INSERT INTO `documents` (complaintId, type, date, language) VALUES(" . $fields['id'] . ", 'internal8d', '" . common::nowDateForMysql() . "', 'de')");
