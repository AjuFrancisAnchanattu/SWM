...
class generateSupplierLetteren extends page
{	
	...
	public function generateWordDocument()
	{
		...
		$file = './apps/complaints/word/supplierLetter-enTemplate.rtf';
...
*/	
		...
		// Save the file here
		$fpSaveFile = './apps/complaints/word/files/supplierLetter-en' . $fields['id'] .  '.rtf';				
		...
		chmod("./apps/complaints/word/files/supplierLetter-en" . $fields['id'] .  ".rtf", 0777);
		...
		mysql::getInstance()->selectDatabase("complaints")->Execute("INSERT INTO `documents` (complaintId, type, date, language) VALUES(" . $fields['id'] . ", 'supplierLetter', '" . common::nowDateForMysql() . "', 'en')");
