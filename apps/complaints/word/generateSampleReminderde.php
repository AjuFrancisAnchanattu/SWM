...
class generateSampleReminderde extends page
{	
	...
	public function generateWordDocument()
	{
		...
		$file = './apps/complaints/word/sampleReminderde.rtf';
		...
		$dateDiff = $this->datediff($fields['openDate'], date("Y-m-d")) . " Tag(en)";
		...
		// Save the file here
		$fpSaveFile = './apps/complaints/word/files/sampleRem-de' . $fields['id'] .  '.rtf';
		...
		chmod("./apps/complaints/word/files/sampleRem-de" . $fields['id'] .  ".rtf", 0777);
		...
		mysql::getInstance()->selectDatabase("complaints")->Execute("INSERT INTO `documents` (complaintId, type, date, language) VALUES(" . $fields['id'] . ", 'sampleRem', '" . common::nowDateForMysql() . "', 'de')");
