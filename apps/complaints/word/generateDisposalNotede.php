...
class generateDisposalNotede extends page
{	
	...
	public function generateWordDocument()
	{
		...
		$file = './apps/complaints/word/disposalNote-deTemplate.rtf';
		...
		// Save the file here
		$fpSaveFile = './apps/complaints/word/files/disposalNote-de' . $fields['id'] .  '.rtf';
		...
		chmod("./apps/complaints/word/files/disposalNote-de" . $fields['id'] .  ".rtf", 0777);
		...
		mysql::getInstance()->selectDatabase("complaints")->Execute("INSERT INTO `documents` (complaintId, type, date, language) VALUES(" . $fields['id'] . ", 'disposalNote', '" . common::nowDateForMysql() . "', 'de')");
