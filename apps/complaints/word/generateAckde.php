...
class generateAckde extends page
{	
...
//		new bit ends
		...
		$file = './apps/complaints/word/ack-deTemplate.rtf';
...
//		$scInvoiceDate = $sapInvoiceDateResults;
		...
		// Save the file here
		$fpSaveFile = './apps/complaints/word/files/ack-de' . $fields['id'] .  '.rtf';
		...
		chmod("./apps/complaints/word/files/ack-de" . $fields['id'] .  ".rtf", 0777);
		...
		mysql::getInstance()->selectDatabase("complaints")->Execute("INSERT INTO `documents` (complaintId, type, date, language) VALUES(" . $fields['id'] . ", 'ack', '" . common::nowDateForMysql() . "', 'de')");
