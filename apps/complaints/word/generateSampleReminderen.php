...
class generateSampleReminderen extends page
{	
	...
	public function generateWordDocument()
	{
		...
		$file = './apps/complaints/word/sampleReminderen.rtf';
		...
		$undersigned = $fields['internalSalesName'];
		...
		$dateDiff = $this->datediff($fields['openDate'], date("Y-m-d")) . " day(s)";
		...
		// Save the file here
		$fpSaveFile = './apps/complaints/word/files/sampleRem-en' . $fields['id'] .  '.rtf';
		...
		chmod("./apps/complaints/word/files/sampleRem-en" . $fields['id'] .  ".rtf", 0777);
		...
		mysql::getInstance()->selectDatabase("complaints")->Execute("INSERT INTO `documents` (complaintId, type, date, language) VALUES(" . $fields['id'] . ", 'sampleRem', '" . common::nowDateForMysql() . "', 'en')");
