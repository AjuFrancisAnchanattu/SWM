...
class generateReturnFormde extends page
{	
	...
	public function generateWordDocument()
	{
		...
		$file = './apps/complaints/word/returnForm-deTemplate.rtf';
		...
		// Save the file here
		$fpSaveFile = './apps/complaints/word/files/returnForm-de' . $fields['id'] .  '.rtf';
		...
		chmod("./apps/complaints/word/files/returnForm-de" . $fields['id'] .  ".rtf", 0777);
		...
		mysql::getInstance()->selectDatabase("complaints")->Execute("INSERT INTO `documents` (complaintId, type, date, language) VALUES(" . $fields['id'] . ", 'returnForm', '" . common::nowDateForMysql() . "', 'de')");
