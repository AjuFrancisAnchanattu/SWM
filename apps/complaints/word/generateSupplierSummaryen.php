...
class generateSupplierSummaryen extends page
{	
	...
	public function generateWordDocument()
	{
		...
		$file = './apps/complaints/word/complaintSummary-enTemplate.rtf';
...
*/	
		...
		// Save the file here
		$fpSaveFile = './apps/complaints/word/files/complaintSummary-en' . $fields['id'] .  '.rtf';				
		...
		chmod("./apps/complaints/word/files/complaintSummary-en" . $fields['id'] .  ".rtf", 0777);
		
		$this->addLog("Summary Page Created");
		
		mysql::getInstance()->selectDatabase("complaints")->Execute("DELETE FROM `documents` WHERE complaintId='" . $fields['id'] . "' AND type = 'supplierSummary'");	
		mysql::getInstance()->selectDatabase("complaints")->Execute("INSERT INTO `documents` (complaintId, type, date, language) VALUES(" . $fields['id'] . ", 'supplierSummary', '" . common::nowDateForMysql() . "', 'en')");
