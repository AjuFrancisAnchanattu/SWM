...
class chart_ByNumber_ByMonth_Customer extends dashboardsLib
{
	public function getChartXML()
	{
		$xml = "<chart caption='Complaints Number by Month (Customer Complaints)' labelDisplay='stagger' showValues='1' decimals='1' useRoundEdges='1' exportEnabled='1' exportAtClient='1' exportHandler='ccChart_openClosed_Exporter' registerWithJS='1' exportFileName='ccChart_ByNumber_ByMonth_Customer' >";
		...
		foreach( $fiscal as $period )
		{
			...
			$link = 'JavaScript:chartByNumber.chart_ByNumber_BySite("' . $linkPeriod . '")';
