...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="ccAddComment">
					...
					<div class="title-box1">
						<div class="left-top-corner"><div class="right-top-corner"><div class="right-bot-corner"><div class="left-bot-corner">
							<div class="inner"><div class="wrapper">
								<img src="../../images/famIcons/add.png" style="float: left;" alt="" class="titleIcon" />
									<p style="margin: 0 0 0 3px; float: left; font-weight: bold; color: #FFFFFF;">
