		...
		<table width="100%" cellpadding="0">
			<tr>
				...
				<td valign="top" style="padding: 10px;">
					...
					<xsl:if test="approvalStop">
						<div id="warningPrompt" style="margin: 5px; padding: 5px; text-align: center; border: 1px #FF3838 solid; background: #FFD8D8">
							{TRANSLATE:takeover_approval_warning}
						</div>
					</xsl:if>
