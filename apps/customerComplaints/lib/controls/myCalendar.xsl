...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="calendar">
		...
		<!--<a href="#" onClick="cal1x.select(document.forms[0].elements['{name}'],'{name}','dd MMM yyyy'); return false;" name="{name}" id="{name}"><img src="/images/icons2020/calender.jpg" alt="Open Calendar" /></a>-->
		<a href="#" onClick="cal1x.select(document.getElementById('{name}'),'{name}','dd NNN yyyy'); return false;" name="{name}" id="{name}"><img src="/images/icons2020/calender.jpg" alt="Open Calendar" /></a>
